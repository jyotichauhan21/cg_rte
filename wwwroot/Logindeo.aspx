<%@ Page Title="" Language="C#" MasterPageFile="~/wwwroot/Admin/Master.master" AutoEventWireup="true" CodeFile="Logindeo.aspx.cs" Inherits="wwwroot_Logindeo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="width:700px; margin-left:350px; margin-top:50px;">
            <h2 style="text-align:center; background-color:lightgreen; padding:10px;"> DEO Login Form</h2>
        </div>
