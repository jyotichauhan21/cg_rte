<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Signup.aspx.cs" Inherits="wwwroot_Signup" %>
    ...
    <script language="javascript" type="text/ecmascript">
        function ValidateForm() {
            ...
            if (User == "" && Pass1 == "" && Pass2 == "" && Email == "") {
                alert("All fields are neccesary to be fill!");
                ...
                alert("Confirm password is necessary!");
                ...
                alert("Passwords should be  atleast 4 charecter or maximum 18!");
